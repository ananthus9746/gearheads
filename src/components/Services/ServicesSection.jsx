          ...
          <div className="sidebar width-none">
            <div className="services-content">
              <SectionHeading
                ...
                desp={
                  "At Gear Heads Auto Garage, we go beyond standard repairs with our specialized services. Whether you need fleet maintenance, vintage car restoration, or advanced diagnostics, our team is equipped to handle it all. Trust us to deliver unmatched expertise and attention to detail."
                }
              />
