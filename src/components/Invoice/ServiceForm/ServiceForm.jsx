...
const ServiceForm = () => {
  ...
  return (
    <div style={{ padding: '20px',backgroundColor:"white",color:"black" }} id="service-form-container">
      <h2 style={{color:"black"}}>Service Checklist</h2>

      {/* New Input Fields */}
      <div className={styles.vehicleDetails}>
        <h3 style={{ color: "black" }}>Vehicle Details</h3>
